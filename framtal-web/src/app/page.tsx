          ...
          <aside className="space-y-4">
            ...
            <nav className="bg-blue p-4 rounded-xl">
              ...
              <ul className="space-y-2 text-blue-700 font-light">
                <li className="p-2">
                  <a href="#">Álagningarseðill</a>
                </li>
                <li className="p-2">
                  <a href="#">Bráðabirgðaútreikningur</a>
                </li>
                <li className="p-2">
                  ...
                  <ul className="space-y-1 mt-3 pl-4 border-l border-gray-30 text-sm">
                    <li className="p-2">
                      <a href="#" className="font-bold">
                        Hvernig skila ég framtali?
                      </a>
                    </li>
                    <li className="p-2">
                      <a href="#">Skilafrestur og útgreiðslur</a>
                    </li>
                    <li className="p-2">
                      <a href="#">Umsóknir og leiðréttingar</a>
                    </li>
                    <li className="p-2">
                      <a href="#">Rafræn skilríki og veflykill</a>
                    </li>
                    <li className="p-2">
                      <a href="#">Vaxtabætur</a>
                    </li>
                ...
                <li className="p-2">
                  <a href="#">Algengar spurningar</a>
                </li>
                <li className="p-2">
                  <a href="#">Skattar vegna atvinnu erlendis</a>
                </li>
              </ul>
            </nav>
            ...
            <div className="bg-gray p-4 rounded-xl">
              ...
              <ul className="space-y-1 font-light text-gray-600">
                ...
                <li className="p-2">
                  <a href="#">Staðgreiðsla</a>
                </li>
                <li className="p-2">
                  <a href="#">RSK 1.02 Skattframtal barns</a>
                </li>
                <li className="p-2">
                  <a href="#">RSK 1.04 Skattframtal rekstraraðila (lögaðila)</a>
                </li>
                <li className="p-2">
                  <a href="#">RSK 1.06 Framtal óskattskyldra lögaðila</a>
                </li>
              </ul>
            </div>
          </aside>
          ...
          <main className="space-y-8">
            ...
            <header className="space-y-2">
              <h1 className="text-3xl font-bold">
                Hér getur þú skilað skattframtali einstaklinga fyrir árið 2025
              </h1>
            </header>
            ...
            <section className="space-y-4">
              <div className="bg-blue rounded-xl text-blue-700 p-6 flex justify-between items-center mb-8">
                ...
                <a
                  className="bg-blue-600 text-white font-bold rounded-lg p-4 flex"
                  href="/innskraning"
                >
                  Opna framtal{' '}
                  <svg
              ...
              <p className="text-gray-700  leading-relaxed">
                Flestar upplýsingar eru forskráðar en gott er að yfirfara. Þú getur bætt við og
                breytt upplýsingum. Að lokum þarft þú að staðfesta og skila framtali.
              </p>
              <h3 className="font-semibold">Almennar upplýsingar</h3>
              <p className="text-gray-700  leading-relaxed">
                Flestar upplýsingar í framtalinu eru forskráðar. Þú þarft að yfirfara þær og
                staðfesta eða breyta ef nauðsyn krefur. Þegar öll gögn eru rétt og tilbúin skilarðu
                framtalinu með einföldum hætti í lok ferlisins. Þú skráir þig inn með rafrænum
                skilríkjum eða veflykli frá Skattinum. Framtalið er opið frá 1. mars til 14. mars
                2025. Ekki er hægt að sækja um framlengdan skilafrest. Allir einstaklingar 16 ára og
                eldri sem voru búsettir á Íslandi árið 2024, höfðu tekjur eða áttu eignir, þurfa að
                skila framtali.
              </p>
              <h3 className="font-semibold">Að skrá sig inn</h3>
              <p className="text-gray-700  leading-relaxed">
                Smelltu á hnappinn „Opna framtal“ til að hefja ferlið. Þú getur auðkennt þig með
                rafrænum skilríkjum eða veflykli frá Skattinum. Ef þú ert ekki með veflykil geturðu
                sótt hann á skattur.is með því að slá inn kennitölu og velja afhendingarmáta.
              </p>
              <h3 className="font-semibold">Hvað gerist eftir að framtali er skilað?</h3>
              <p className="text-gray-700  leading-relaxed">
                Þú færð staðfestingu á vefnum þegar skilað hefur verið. Skilaboð berast einnig í
                pósthólfið þitt á Ísland.is. Fæ ég endurgreiðslu eða þarf ég að borga? Niðurstöður
                álagningar birtast í lok maí. Ef of mikið var dregið af í staðgreiðslu færðu
                endurgreiðslu. Ef of lítið var dregið af þarftu að greiða mismuninn.
              </p>
              <h3 className="font-semibold">Greidd leiga og fylgiskjöl</h3>
              <p className="text-gray-700  leading-relaxed">
                Ef þú greiddir leigu á árinu 2024 þarftu að skila upplýsingum um leigusala og
                greiðslur. Þetta er gert með því að fylla út fylgiskjal RSK 2.02 sem þú sendir með
                framtalinu.
              </p>
              ...
              <p className="text-gray-700  leading-relaxed">
                ...
                Þú þarft einnig að gera grein fyrir uppruna þeirra og skattlagningu í viðkomandi
                landi.
              </p>
              <h3 className="font-semibold">Þarftu aðstoð?</h3>
              <p className="text-gray-700  leading-relaxed">
                Sími: 442 1414 Netfang: framtal@skatturinn.is
              </p>
            </section>
          </main>
        </div>
